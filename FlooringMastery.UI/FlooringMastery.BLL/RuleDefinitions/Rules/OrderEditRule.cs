...
{
    public class OrderEditRule : IEdit
    {
        public OrderEditResponse Edit(List<Product> products, List<Tax> taxes, string customerName, string state, string productType, decimal area)
        {
